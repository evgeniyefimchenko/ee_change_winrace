			...
			{if $product}
				...
				<div class="ut2-pb__right">
					...
					<div class="info-brand__cart">						
						<a title="Задать вопрос о товаре" class="{if "MULTIVENDOR"|fn_allowed_for}ty-vendor-communication__post-write{/if} cm-dialog-opener cm-dialog-auto-size info-brand__item" data-ca-target-id="new_thread_dialog_{$product.product_id}" rel="nofollow">
							<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
								...
								<span class="info-brant__title" style="float: right;">Задать вопрос о товаре</span>
						</a>
						<a href="/index.php?dispatch=companies.view&company_id={$product.company_id}" class="info-brand__item">
							<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
							...
							<span class="info-brant__title">{$product.company_name}</span>
						</a>
					</div>
