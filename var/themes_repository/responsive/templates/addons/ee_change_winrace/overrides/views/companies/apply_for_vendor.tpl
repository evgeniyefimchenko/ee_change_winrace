{if $addons.ee_change_winrace.ee_change_winrace_vendor == "Y"}
	...
	<style> @import url('https://fonts.googleapis.com/css2?family=Roboto:wght@100;400;500;700&display=swap'); </style>
				...
				<div class="my-profile__container">
					...
					<form action="{"companies.apply_for_vendor"|fn_url}" method="post" name="apply_for_vendor_form" enctype="multipart/form-data">
						...
						<div class="form-profile__half-row-inputs form-label">
							...
							<div class="text-field text-field_floating">
								<label class="select-drop form-profile__input-label" for="state">
						...
						<div class="form-profile__half-row-inputs form-label">
                            <div class="text-field text-field_floating">
                                <input autocomplete="off" type="text" placeholder="Какая у вас продукция, где можно посмотреть ваши товары?" name="company_data[fields][72]" class="text-field__input">
						...
						<div class="form-profile__bottom form-profile__bottom_seller ">
							<div class="checkbox">
								...
								<label for="c_1" class="checkbox__label">
									<span class="checkbox__text checkbox__text_thing">Заполняя данную форму, Вы подтверждаете своё полное согласие с <a href="/politika-konfidencialnosti/">политикой обработки персональных данных</a>, <a href="/politika-konfidencialnosti/">условиями пользовательского соглашения</a><br>и с <a href="/politika-konfidencialnosti/">Положением о порядке доступа и условиях использования личного кабинета продавца</a></span>
								</label>
							</div>
